...
function is_mobile (){
	...
	var dig1 = parseInt(document.getElementById("digit1").innerHTML);
	var dig2 = parseInt(document.getElementById("digit2").innerHTML);
	var answer	= $('#answer').val();

	var sum = dig1 + dig2;
	var not_cool = $('.met_contact_not_cool');
	...
	if(sum == answer)
	{
		...
		$.ajax({
			...
			success: function(returnedInfo){
				...
				if (returnedInfo == true){
					...
					not_cool.html('Please try again and make sure you fill all the inputs').show();
					setInterval(function(){not_cool.fadeOut()},10000);
				}
		...
		if(sum != answer){
			not_cool.html('The verification code is wrong!').show();
			$('#answer').val('');
			setInterval(function(){not_cool.fadeOut()},10000);
		}
	}
